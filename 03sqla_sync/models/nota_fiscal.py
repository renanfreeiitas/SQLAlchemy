...
class NotaFiscal(ModelBase):
    ...
    id_revendedor: int = sa.Column(
        sa.Integer, sa.ForeignKey('revendedores.id'))
    revendedor: Revendedor = orm.relationship(
        'Revendedor', lazy='joined')  # configuracao interna do SQL Alchemy

    # Uma nota fiscal pode ter varios lotes e um lote esta ligado a uma nota fiscal
